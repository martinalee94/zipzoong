...
class House(TimeStampModel, models.Model):
    ...
    seller = models.ForeignKey(Seller, related_name="house", on_delete=models.SET_DEFAULT, db_index=True, default="deleted")
...
class HouseBidInfo(TimeStampModel, models.Model):
    ...
    contact_req = models.CharField(verbose_name="연락요청 여부", max_length=2, choices=yes_no, default="N")
    success_bid = models.CharField(verbose_name="낙찰 성공 여부", max_length=2, choices=yes_no, default="N")
